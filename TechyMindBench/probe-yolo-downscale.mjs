#!/usr/bin/env node
// ─────────────────────────────────────────────────────────────────────────────
// TechyMindBench/probe-yolo-downscale.mjs — v1.16.0 A/B CORRECTNESS PROBE
...
//
//   node TechyMindBench/probe-yolo-downscale.mjs
// ─────────────────────────────────────────────────────────────────────────────
...
const ROOT = join(dirname(fileURLToPath(import.meta.url)), '..');   // probe sits at TechyMindBench/ — one level below repo root
const OUT_DIR = join(ROOT, 'TechyMindBench', 'results');
const BASE = 'http://127.0.0.1:8893';
const PAGES = [
  '/TechyMindBench/pages/redaction-lab.html',
  '/TechyMindBench/pages/mixed-ui.html',
  '/TechyMindBench/pages/media.html',
];
