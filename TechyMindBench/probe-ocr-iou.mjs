#!/usr/bin/env node
// TechyMindBench/probe-ocr-iou.mjs — v1.14: diagnose the OCR bounding-box error
...
await page.goto('http://127.0.0.1:8897/TechyMindBench/pages/pii-visual.html', { waitUntil: 'networkidle' });
