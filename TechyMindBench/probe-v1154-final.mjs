#!/usr/bin/env node
// TechyMindBench/probe-v1154-final.mjs — final visual proof for the field round:
...
const faceHtml = readFileSync(ROOT + '/TechyMindBench/e2e/adversarial/priv-face.html', 'utf8');
...
writeFileSync(ROOT + '/TechyMindBench/results/probe-v1154-final-sanitized.png', Buffer.from(r.sanitized.split(',')[1], 'base64'));
writeFileSync(ROOT + '/TechyMindBench/results/probe-v1154-final-raw.png', Buffer.from(imageDataUrl.split(',')[1], 'base64'));
console.log('saved → TechyMindBench/results/probe-v1154-final-{raw,sanitized}.png');
