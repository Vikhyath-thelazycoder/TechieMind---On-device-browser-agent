#!/usr/bin/env node
// TechyMindBench/probe-small-avatar.mjs
...
for (const v of VARIANTS) {
  ...
  writeFileSync(ROOT + `/TechyMindBench/results/probe-small-avatar-${safe}.png`, Buffer.from(r1.sanitized.split(',')[1], 'base64'));
  await ctx.close();
}
console.log('sanitized shots → TechyMindBench/results/probe-small-avatar-*.png');
