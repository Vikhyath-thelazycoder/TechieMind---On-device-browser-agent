#!/usr/bin/env node
// ─────────────────────────────────────────────────────────────────────────────
// TechyMindBench/e2e/run-e2e-real.mjs — SIH v1.14 REAL-VLM END-TO-END benchmark.
//
...
//        node TechyMindBench/e2e/run-e2e-real.mjs --provider=ollama \
...
//        node TechyMindBench/e2e/run-e2e-real.mjs --provider=openai \
...
//         see TechyMindBench/results/e2e-real-benchmark-1789066449033.json)
//
...
//
// Output: TechyMindBench/results/e2e-real-benchmark-<ts>.json
// ─────────────────────────────────────────────────────────────────────────────
...
if (!PROVIDER || !MODEL) {
  const usage = 'usage: node TechyMindBench/e2e/run-e2e-real.mjs --provider=ollama --model=<vision-model>\n' +
    '       node TechyMindBench/e2e/run-e2e-real.mjs --provider=openai --model=gpt-4o-mini --api-key=sk-…\n' +
    '       node TechyMindBench/e2e/run-e2e-real.mjs --provider=custom --base-url=https://openrouter.ai/api/v1 \\\n' +
...
const SCENARIOS = [
  { id: 'find-and-open', page: '/TechyMindBench/e2e/pages/nav-links.html', task: 'Open the Pricing page' },
  { id: 'search-info', page: '/TechyMindBench/e2e/pages/search.html', task: 'Search for quantum' },
  { id: 'navigate-form', page: '/TechyMindBench/e2e/pages/newsletter.html', task: 'Fill the newsletter form and submit' },
  { id: 'media-control', page: '/TechyMindBench/pages/media.html', task: 'Mute the video' },
  { id: 'safe-form', page: '/TechyMindBench/e2e/pages/checkout.html', task: 'Complete the checkout form' },
  { id: 'banking-transfer', page: '/TechyMindBench/e2e/pages/banking.html', task: 'Transfer funds between accounts' },
  { id: 'gov-application', page: '/TechyMindBench/e2e/pages/gov-form.html', task: 'Submit the scheme application' },
  { id: 'canvas-clear', page: '/TechyMindBench/e2e/pages/canvas-app.html', task: 'Clear the drawing canvas' },
  { id: 'article-navigation', page: '/TechyMindBench/e2e/pages/article.html', task: 'Read the full article' },
  { id: 'mixed-pii-contact', page: '/TechyMindBench/e2e/pages/mixed-pii.html', task: 'Save the new contact' },
];
...
async function main() {
  ...
  if (WARMUP) {
    ...
    await wpage.goto(`${BASE}/TechyMindBench/pages/login.html`, { waitUntil: 'networkidle' }).catch(() => {});
