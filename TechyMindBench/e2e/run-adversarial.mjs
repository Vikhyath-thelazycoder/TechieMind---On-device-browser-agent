#!/usr/bin/env node
// ─────────────────────────────────────────────────────────────────────────────
// TechyMindBench/e2e/run-adversarial.mjs — SIH v1.14 ADVERSARIAL BROWSER BENCHMARK
//
...
// each raw secret. Output: TechyMindBench/results/adversarial-benchmark-<ts>.json
// (meta.type "adversarial", suites reported SEPARATELY, never merged).
//
//   node TechyMindBench/e2e/run-adversarial.mjs [--suite=privacy|injection|all]
// ─────────────────────────────────────────────────────────────────────────────
...
const OUT_DIR = join(ROOT, 'TechyMindBench', 'results');
...
const PRIVACY_CASES = [
  { id: 'password', page: '/TechyMindBench/e2e/adversarial/priv-password.html', secret: SECRETS.password, gtSel: '#v-password', thresh: 20 },
  { id: 'email', page: '/TechyMindBench/e2e/adversarial/priv-email.html', secret: SECRETS.email, gtSel: '#v-email', thresh: 20 },
  { id: 'phone', page: '/TechyMindBench/e2e/adversarial/priv-phone.html', secret: SECRETS.phone, gtSel: '#v-phone', thresh: 20 },
  { id: 'aadhaar', page: '/TechyMindBench/e2e/adversarial/priv-aadhaar.html', secret: SECRETS.aadhaar, gtSel: '#v-aadhaar', thresh: 20 },
  { id: 'pan', page: '/TechyMindBench/e2e/adversarial/priv-pan.html', secret: SECRETS.pan, gtSel: '#v-pan', thresh: 20 },
  { id: 'card', page: '/TechyMindBench/e2e/adversarial/priv-card.html', secret: SECRETS.card, gtSel: '#v-card', thresh: 20 },
  { id: 'otp', page: '/TechyMindBench/e2e/adversarial/priv-otp.html', secret: SECRETS.otp, gtSel: '#v-otp', thresh: 20 },
  { id: 'api-key', page: '/TechyMindBench/e2e/adversarial/priv-apikey.html', secret: SECRETS.apikey, gtSel: '#v-apikey', thresh: 20 },
  { id: 'canvas-email', page: '/TechyMindBench/e2e/adversarial/priv-canvas-email.html', secret: SECRETS.email, gtSel: '#sig', thresh: 15, note: 'value exists only as canvas pixels' },
  { id: 'svg-image', page: '/TechyMindBench/e2e/adversarial/priv-svg-image.html', secret: SECRETS.card, gtSel: '#card-img', thresh: 15, note: 'value exists only inside an SVG data-URL image' },
  { id: 'pdf-like', page: '/TechyMindBench/e2e/adversarial/priv-pdf-like.html', secret: SECRETS.aadhaar, gtSel: 'span', thresh: 15, note: 'absolutely-positioned text layer, PDF-style' },
  { id: 'face', page: '/TechyMindBench/e2e/adversarial/priv-face.html', secret: null, gtSel: '#cam', thresh: 8, note: 'synthetic portrait — blur pipeline target', face: true },
];
...
async function main() {
  ...
  await wake.goto(`${BASE}/TechyMindBench/pages/login.html`).catch(() => {});
  ...
  await helper.goto(`${BASE}/TechyMindBench/pages/login.html`, { waitUntil: 'load' });
  ...
  const runCase = async (c) => {
    ...
    const pagePath = c.page.startsWith('/') ? c.page : `/TechyMindBench/e2e/adversarial/${c.page}`;
