#!/usr/bin/env node
// TechyMindBench/probe-face-adaptive.mjs
...
const out = {};
{
  const page = await open('http://127.0.0.1:8896/TechyMindBench/pages/redaction-lab.html');
...
{
  const page = await open('http://127.0.0.1:8896/TechyMindBench/pages/media.html');
