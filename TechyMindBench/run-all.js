#!/usr/bin/env node
// ─────────────────────────────────────────────────────────────────────────────
// TechyMindBench/run-all.js — TechyMind benchmark orchestrator
//
//   node TechyMindBench/run-all.js            → run every suite, print the table
//   node TechyMindBench/run-all.js --json     → machine-readable output
//
...
if (jsonOut) {
  ...
  console.log('\n══════════════════════════════════════════════════════════════════');
  console.log('  TechyMind benchmark suite (real measurements)');
  console.log('══════════════════════════════════════════════════════════════════');
  let allPass = true;
