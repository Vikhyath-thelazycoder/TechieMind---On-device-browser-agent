...
export function validateInboundRequest(input = {}) {
  ...
  const requireVerified = process.env.TECHYMIND_ACCEPT_UNVERIFIED !== '1' && process.env.OPENCOMET_ACCEPT_UNVERIFIED !== '1';
  if (requireVerified) {
    ...
    reasons.push('privacyVerification.passed is false — refusing (TECHYMIND_ACCEPT_UNVERIFIED only relaxes ABSENCE)');
  }
